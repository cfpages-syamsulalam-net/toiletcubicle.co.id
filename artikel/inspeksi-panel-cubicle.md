...
title: "Inspeksi Tepi, Lubang, dan Finishing Panel"
slug: "inspeksi-panel-cubicle"
description: "Identify defects, measurements, damage, and records"
status: outline
...
final_route: "/artikel/inspeksi-panel-cubicle.html"
...
# Inspeksi Tepi, Lubang, dan Finishing Panel

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Inspeksi Tepi, Lubang, dan Finishing Panel”
- **Reader and situation:** Factory QA
- **Reader outcome:** Identify defects, measurements, damage, and records
...
- **Scope boundary:** Material identity belongs to TCB-09-06
- **Final public route:** `/artikel/inspeksi-panel-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Inspeksi Tepi, Lubang, dan Finishing Panel**.
...
- `TCB-09-02` → `/artikel/alur-fabrikasi-toilet-cubicle.html` — Alur Fabrikasi dari Drawing hingga Packing
- `TCB-09-03` → `/artikel/inspection-test-plan-cubicle.html` — Inspection and Test Plan Cubicle
- `TCB-09-05` → `/artikel/trial-assembly-cubicle.html` — Trial Assembly sebelum Pengiriman
- `TCB-09-06` → `/artikel/traceability-nonconformance-cubicle.html` — Traceability dan Nonconformance Material
...
- **Tie back to this article:** Keep the explanation specific to “Inspeksi Tepi, Lubang, dan Finishing Panel”.
