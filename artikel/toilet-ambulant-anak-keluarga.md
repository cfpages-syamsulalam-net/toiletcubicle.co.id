...
title: "Toilet Ambulant, Anak, dan Keluarga"
slug: "toilet-ambulant-anak-keluarga"
description: "Separate support, supervision, reach, privacy, and fixture needs"
status: outline
...
final_route: "/artikel/toilet-ambulant-anak-keluarga.html"
...
# Toilet Ambulant, Anak, dan Keluarga

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Toilet Ambulant, Anak, dan Keluarga”
- **Reader and situation:** Public facility
- **Reader outcome:** Separate support, supervision, reach, privacy, and fixture needs
...
- **Scope boundary:** Wheelchair layout remains TCB-03-02
- **Final public route:** `/artikel/toilet-ambulant-anak-keluarga.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Toilet Ambulant, Anak, dan Keluarga**.
...
- `/artikel/5-tips-anak-cepat-lulus-toilet-training` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `TCB-03-01` → `/artikel/prinsip-toilet-cubicle-aksesibel.html` — Prinsip Toilet Cubicle Aksesibel
- `TCB-03-02` → `/artikel/ruang-gerak-transfer-pintu-toilet.html` — Ruang Gerak, Transfer, dan Pintu Toilet Aksesibel
- `TCB-03-04` → `/artikel/hardware-pintu-aksesibel.html` — Hardware Pintu yang Mendukung Pengguna Beragam
- `TCB-03-05` → `/artikel/privasi-dan-pendamping-toilet-inklusif.html` — Privasi dan Bantuan Pendamping dalam Toilet Inklusif
...
- **Tie back to this article:** Keep the explanation specific to “Toilet Ambulant, Anak, dan Keluarga”.
