...
title: "Pintu Seret, Turun, atau Tidak Mengunci"
slug: "masalah-pintu-toilet-cubicle"
description: "Check obstruction, alignment, hinges, latch, closer, and movement"
status: outline
publication_date: "2026-04-07"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TCB-11
primary_intent: "Diagnose doors"
reader_community: "Toiletcubicle.co.id"
reader_address: "Kawan Toiletcubicle.co.id"
final_route: "/artikel/masalah-pintu-toilet-cubicle.html"
...
# Pintu Seret, Turun, atau Tidak Mengunci

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pintu Seret, Turun, atau Tidak Mengunci”
- **Reader and situation:** Maintenance team
- **Reader outcome:** Check obstruction, alignment, hinges, latch, closer, and movement
- **Primary intent:** Diagnose doors
...
- **Scope boundary:** Unsafe movement escalates to TCB-11-01
- **Final public route:** `/artikel/masalah-pintu-toilet-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pintu Seret, Turun, atau Tidak Mengunci**.
...
- `TCB-11-01` → `/artikel/triage-kerusakan-toilet-cubicle.html` — Triage Kerusakan Toilet Cubicle
- `TCB-11-02` → `/artikel/kerusakan-permukaan-panel-cubicle.html` — Panel Mengembung, Mengelupas, atau Berubah Warna
- `TCB-11-04` → `/artikel/kaca-cubicle-retak-pecah.html` — Kaca Retak atau Pecah
- `TCB-11-05` → `/artikel/jadwal-perawatan-toilet-cubicle.html` — Jadwal Inspeksi dan Perawatan Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “Pintu Seret, Turun, atau Tidak Mengunci”.
