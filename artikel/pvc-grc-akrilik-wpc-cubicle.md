...
title: "PVC, GRC, Akrilik, dan WPC untuk Cubicle"
slug: "pvc-grc-akrilik-wpc-cubicle"
description: "Compare stiffness, water, impact, fastening, finish, and evidence"
status: outline
...
final_route: "/artikel/pvc-grc-akrilik-wpc-cubicle.html"
...
# PVC, GRC, Akrilik, dan WPC untuk Cubicle

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “PVC, GRC, Akrilik, dan WPC untuk Cubicle”
- **Reader and situation:** Cost/design reviewer
- **Reader outcome:** Compare stiffness, water, impact, fastening, finish, and evidence
...
- **Scope boundary:** Glass belongs to TCB-04-04
- **Final public route:** `/artikel/pvc-grc-akrilik-wpc-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **PVC, GRC, Akrilik, dan WPC untuk Cubicle**.
...
- **Exact Markdown to insert:** `![Ilustrasi Cubicle Toilet Akrilik 3](/wp-content/uploads/2020/02/Cubicle-Toilet-Akrilik-3.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Cubicle Toilet Akrilik 3` as relevant content media; no pixels were inspected.
...
- `TCB-04-01` → `/artikel/memilih-material-toilet-cubicle.html` — Memilih Material Toilet Cubicle Berdasarkan Paparan
- `TCB-04-02` → `/artikel/phenolic-compact-vs-hpl-multiplex.html` — Phenolic Compact vs HPL Multiplex
- `TCB-04-04` → `/artikel/kaca-untuk-toilet-cubicle.html` — Kaca untuk Toilet Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “PVC, GRC, Akrilik, dan WPC untuk Cubicle”.
