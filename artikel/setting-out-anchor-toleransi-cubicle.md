...
title: "Setting Out, Anchor, dan Toleransi Instalasi"
slug: "setting-out-anchor-toleransi-cubicle"
description: "Define reference lines, substrate confirmation, hold points, and records"
status: outline
...
final_route: "/artikel/setting-out-anchor-toleransi-cubicle.html"
...
# Setting Out, Anchor, dan Toleransi Instalasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Setting Out, Anchor, dan Toleransi Instalasi”
- **Reader and situation:** Installer/inspector
- **Reader outcome:** Define reference lines, substrate confirmation, hold points, and records
...
- **Scope boundary:** Anchor design remains TCB-06-02
- **Final public route:** `/artikel/setting-out-anchor-toleransi-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Setting Out, Anchor, dan Toleransi Instalasi**.
...
- `TCB-10-01` → `/artikel/kesiapan-lokasi-toilet-cubicle.html` — Checklist Kesiapan Lokasi sebelum Pengiriman
- `TCB-10-02` → `/artikel/urutan-pemasangan-toilet-cubicle.html` — Urutan Pemasangan Toilet Cubicle
- `TCB-10-04` → `/artikel/pemasangan-di-toilet-aktif.html` — Pemasangan di Toilet yang Tetap Beroperasi
...
- **Tie back to this article:** Keep the explanation specific to “Setting Out, Anchor, dan Toleransi Instalasi”.
