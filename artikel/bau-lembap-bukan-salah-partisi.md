...
title: "Bau dan Lembap: Kapan Bukan Salah Partisi"
slug: "bau-lembap-bukan-salah-partisi"
description: "Separate ventilation, plumbing, drainage, occupancy, and panel symptoms"
status: outline
publication_date: "2026-01-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TCB-08
primary_intent: "Diagnose context"
reader_community: "Toiletcubicle.co.id"
reader_address: "Teman Toiletcubicle.co.id"
final_route: "/artikel/bau-lembap-bukan-salah-partisi.html"
...
# Bau dan Lembap: Kapan Bukan Salah Partisi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Bau dan Lembap: Kapan Bukan Salah Partisi”
- **Reader and situation:** Facility manager
- **Reader outcome:** Separate ventilation, plumbing, drainage, occupancy, and panel symptoms
- **Primary intent:** Diagnose context
...
- **Scope boundary:** HVAC/plumbing design is external
- **Final public route:** `/artikel/bau-lembap-bukan-salah-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Bau dan Lembap: Kapan Bukan Salah Partisi**.
...
- `/pvc/cubicle-pvc-bau-bau` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/phenolic/cubicle-toilet-phenolic-bau-bau` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/artikel2/mengatasi-bau-yang-mengganggu-dengan-cepat-dan-efisien` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/artikel/mengatasi-bau-yang-mengganggu-dengan-cepat-dan-efisien.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/artikel/8-tips-menghilangkan-bau-toilet` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/artikel/8-tanaman-penghilang-bau-di-toilet` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TCB-08-02` → `/artikel/jalur-air-dan-pengeringan-cubicle.html` — Jalur Air, Genangan, dan Pengeringan
- `TCB-08-03` → `/artikel/bahan-pembersih-dan-material-cubicle.html` — Bahan Pembersih vs Material Cubicle
- `TCB-08-05` → `/artikel/titik-sentuh-toilet-cubicle.html` — Titik Sentuh dan Verifikasi Kebersihan
- `TCB-08-06` → `/artikel/mold-biofilm-klaim-antimikroba.html` — Mold, Biofilm, dan Klaim Antimikroba
...
- **Tie back to this article:** Keep the explanation specific to “Bau dan Lembap: Kapan Bukan Salah Partisi”.
