...
title: "Dukungan dan Titik Lemah Panel Kaca"
slug: "dukungan-panel-kaca-cubicle"
description: "Explain edges, holes, contacts, clearances, and replacement"
status: outline
publication_date: "2025-12-12"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TCB-06
primary_intent: "Review glass support"
reader_community: "Toiletcubicle.co.id"
reader_address: "Kawan Toiletcubicle.co.id"
final_route: "/artikel/dukungan-panel-kaca-cubicle.html"
...
# Dukungan dan Titik Lemah Panel Kaca

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Dukungan dan Titik Lemah Panel Kaca”
- **Reader and situation:** Designer/fabricator
- **Reader outcome:** Explain edges, holes, contacts, clearances, and replacement
- **Primary intent:** Review glass support
...
- **Scope boundary:** No glass sizing; specialist owns it
- **Final public route:** `/artikel/dukungan-panel-kaca-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dukungan dan Titik Lemah Panel Kaca**.
...
- **Exact Markdown to insert:** `![Ilustrasi Cubicle Toilet Kaca 4](/wp-content/uploads/2020/02/Cubicle-Toilet-Kaca-4.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Cubicle Toilet Kaca 4` as relevant content media; no pixels were inspected.
...
- `/kaca/cubicle-kaca-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kaca/cubicle-kaca-tuban-2` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kaca/cubicle-kaca-tuban` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kaca/cubicle-kaca-tegal-2` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kaca/cubicle-kaca-tegal` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kaca/cubicle-kaca-tasikmalaya-2` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TCB-06-03` → `/artikel/anchor-dan-waterproofing-toilet.html` — Penetrasi Anchor tanpa Merusak Waterproofing
- `TCB-06-04` → `/artikel/wobble-defleksi-pintu-cubicle.html` — Wobble, Defleksi, dan Pintu Membanting
- `TCB-06-06` → `/artikel/cubicle-pada-bangunan-bergerak.html` — Cubicle pada Bangunan yang Bergerak
...
- **Tie back to this article:** Keep the explanation specific to “Dukungan dan Titik Lemah Panel Kaca”.
